---
title: "TOKEN1909 Jingzhang AI Nexus — Urban Symbiosis Design for the Century-Old Jingzhang Railway Heritage in the AI Era"
author_github: "MIMConsult"
language: "en"
proposal_format_version: "2"
bilingual_contract_version: "1"
translation_of: "proposal.md"
license: "COMMUNITY-DISPLAY-ONLY"
summary: "Structured on three pillars: Railway Heritage Backbone, Industry-University-City Suture, and Open-Source AI Urban Lab. AI carriers are embedded into the old railway corridor without replacing heritage character; boundaries between campuses, tech parks, and residential neighborhoods are opened so AI scenarios permeate daily blocks; the whole district is delivered as an iterable public test field. Conceptual package produced strictly under provisional boundary and official schema (for professional deepening; official boundary absence does not block content scoring, but all precise conclusions must remain provisional)."
...
- Problem solved: Today three layers of physical breakpoints already exist: university gates, park perimeter walls, and residential fences. AI industry is locked inside standalone office towers — local residents "see it but never use it". University research outputs sit behind campus gates for 3+ years before they reach the market; young open-source contributors have no near-campus collaboration space.
...
![Spatial structure & three-scope framework](assets/figures/land-use-structure.png)
...
| Should do | F&B/retail format mix 40/30/20/10; large parks target 12-18% commercial GFA ratio | Reference from public industrial-park leasing experience, tuneable |
...
The table below selects eight domestic and international urban practices (including AI and park-brand cases) with public sources and verifiable timelines, as the benchmark reference for this scheme's "scattered-block embedding" differentiated positioning [source:AGENT-TASKBOOK] [depth:ai_case_benchmark].

| Case | Location | Timeline | AI Application / Core Mechanism | Public Outcome | Borrowable Element for This Scheme | Limitation / Non-applicable Boundary |
| --- | --- | --- | --- | --- | --- | --- |
| Hangzhou City Brain | Hangzhou Yunqi Town | 2016+ | Vision recognition + signal optimization + traffic dispatch | Arterial efficiency gain | AI Investment Decision Sandbox borrows its multi-source data intake pattern | Published outcomes are averages; Jingzhang heritage-base flow profile differs |
| Xiongan Digital Twin City | Xiongan New Area | 2018+ | BIM + GIS + IoT full-domain modeling | Rongdong pilot demonstration | City-Scale Twin Deduction references its base architecture | Jingzhang is built-area renewal; lacks blank-modeling conditions |
| Shanghai Zhangjiang AI Island | Shanghai Pudong | 2019+ | AI park + application showcase | ~100 AI enterprises入驻 | Industry-University-City Suture borrows its park-community interface | Zhangjiang is a new-build park; Jingzhang is stock renewal |
| Haidian City Brain | Beijing Haidian | 2018+ | Traffic + parking + safety + governance | Multi-scenario data intake | Same district — can directly federate de-identified data | City Brain is management-side; this scheme emphasizes daily block scenarios |
| Shenzhen Pengcheng Lab | Shenzhen Nanshan | 2017+ | Computer vision + video structuring | Urban video analytics capability | AI + public-space video sensing references it | Pengcheng is lab-mode; this scheme is open-block |
| Hefei China Speech Valley | Hefei High-Tech Zone | 2017+ | Speech recognition + industry clustering | ~1000 enterprises入驻 | AI + commercial block borrows its scenario-driven industry path | Hefei is park-cluster; this scheme is scattered-block |
| London Chiswick Park | London | 2001+ | Park brand + event operations (non-AI case) | Event-brand operating model (annual event count as stated in public materials, not an independently audited figure) | Industry-University-City Suture borrows its "event-brand + lifestyle" dual-driver attraction — industry and charm must succeed simultaneously | Chiswick is a new-build business park; Jingzhang is stock renewal + AI scenario embedment |
| Guangzhou Nansha Autonomous-Driving Test Zone | Guangzhou Nansha | 2018+ | V2X + autonomous-driving testing | Open-road test mileage | Unmanned Commercial Operation Test borrows its test framework | Nansha uses dedicated test roads; this scheme requires embedment in daily blocks |

Design intent: The benchmark table locks the scheme's "scattered-block embedding" differentiated positioning, avoiding the park-cluster or closed-campus traps; data gap — outcomes in this table are publicly disclosed values; precise recomputation requires each case's raw data verified under public-sourcing and explainability principles [source:AGENT-TASKBOOK] [depth:ai_case_benchmark].
...
![Core metric recalculation & evidence chain](assets/figures/metrics-evidence.png)
